...
def preprocess_license_plate(license_plate_crop):
    ...
    # Optionally, resize the image to improve OCR on small license plates
...
def read_license_plate(license_plate_crop):
    ...
    preprocessed_image = preprocess_license_plate(license_plate_crop)

    # Configure Tesseract's OCR  for better accuracy
    ...
    # Calculate a confidence score (simple approximation using character ASCII values)
